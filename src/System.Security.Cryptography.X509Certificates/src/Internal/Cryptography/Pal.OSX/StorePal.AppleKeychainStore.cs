...
{
    sealed class AppleKeychainStore : IStorePal
    {
        ...
        public void CloneTo(X509Certificate2Collection collection)
        {
            ...
            {
                AppleStorePal.ReadCollection(identities, dedupedCerts);
            }

            using (SafeCFArrayHandle certs = Interop.AppleCrypto.KeychainEnumerateCerts(_keychainHandle))
            {
                AppleStorePal.ReadCollection(certs, dedupedCerts);
            }
        ...
        {
            Console.WriteLine("CreateKeychain: " + keychainPath);
        ...
        {
            Console.WriteLine("OpenAndUnlock: " + keychainPath);
